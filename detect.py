'''python detect.py --source 'https://www.youtube.com/watch?v=YlXFDUL6Qa4' --weights yolov5s.pt --conf-thres 0.5 --iou-thres 0.45 --max-det 1 --view-img --classes 0'''
'''python detect.py --source sancorner.mp4 --weights yolov5s.pt --conf-thres 0.5 --iou-thres 0.45 --max-det 1 --view-img --classes 0'''
...
"""python detect1.py --source san_meuseum.mp4 --weights yolov5s.pt --conf-thres 0.5 --iou-thres 0.45 --max-det 1 --view-img --classes 0 --device 0"""
